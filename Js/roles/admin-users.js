...
window.addEventListener('load', function(event){
    ...
    getAllUsers().then(data => {
        ...
        pageUsers = users.slice(start, end);
...
//     <button class="btn-page" id="previous" disabled><i class="fas fa-chevron-left"></i></button>
//     <!-- <button class="btn-page active">1</button> -->
//     <span class="pagination-ellipsis">3 of 10</span>
//     <!-- <button class="btn-page">10</button> -->
//     <button class="btn-page" id="next"><i class="fas fa-chevron-right"></i></button>
// </div>
